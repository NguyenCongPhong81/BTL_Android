package com.example.btl_nhom2_tkb.TKB.sukien;
...
import com.example.btl_nhom2_tkb.databinding.FragmentSuKienBinding;
import com.example.btl_nhom2_tkb.TKB.acti.ThoiGianBieuDataBase;

import java.util.ArrayList;
import java.util.Calendar;
import java.util.List;
import static com.example.btl_nhom2_tkb.R.color.lich_sukien;
...
public class SuKienFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding.homnay.setText("Hôm nay: "+cal_ngayhomnay.get(Calendar.DAY_OF_MONTH)+"/"+ (cal_ngayhomnay.get(Calendar.MONTH)+1)+"/"+ cal_ngayhomnay.get(Calendar.YEAR));
