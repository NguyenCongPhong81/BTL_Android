...
// import tạo ra các yêu cầu HTTP như GET, POST
...
import com.example.btl_nhom2_tkb.Login.DangNhapActivity;
import com.example.btl_nhom2_tkb.R;
import com.example.btl_nhom2_tkb.sup.data.Config;
import com.example.btl_nhom2_tkb.sup.data.JsonVolley;
import com.example.btl_nhom2_tkb.sup.network.CheckNetwork;
import com.example.btl_nhom2_tkb.databinding.ActivityMainBinding;

import com.example.btl_nhom2_tkb.GhiChu.GhiChuActivity;
import com.example.btl_nhom2_tkb.TKB.acti.ThoiGianBieuDataBase;
import com.example.btl_nhom2_tkb.TKB.acti.ThoiKhoaBieuActivity;
import com.example.btl_nhom2_tkb.TKB.sukien.UTLSuKien;
import com.example.btl_nhom2_tkb.TKB.thoigianbieu.UTLThoiKhoaBieu;
import com.example.btl_nhom2_tkb.MainActivity2;
...
//    tạo ra 1 biến để lưu trữ các dữ liệu nhỏ dưới dạng keyvalue
                ...
                public void onClick(View v) {
                    ...
                    DatePickerDialog dialog = new DatePickerDialog(v.getContext(), new DatePickerDialog.OnDateSetListener() {
                        ...
                        public void onDateSet(DatePicker view, int year , int month, int day) {
                            ...
                            binding.homeNgay.setText(str_thu + " , " + day +" thg "+ month);
                            show_thoigianbieu();
